...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 px-6 py-4 flex justify-end items-center gap-4">
      <Link
        to="/events"
...
const AuthenticatedLinks = ({ user, logout }: AuthLinksProps) => (
  <>
    <Link
      to="/my-events"
      className="flex items-center gap-1 text-neutral-600 hover:text-neutral-900"
